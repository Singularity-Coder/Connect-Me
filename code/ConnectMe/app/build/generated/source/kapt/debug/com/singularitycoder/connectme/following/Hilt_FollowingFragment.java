 ...
 */
public abstract class Hilt_FollowingFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FollowingFragment() {
    super();
  }

  Hilt_FollowingFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FollowingFragment_GeneratedInjector) this.generatedComponent()).injectFollowingFragment(UnsafeCasts.<FollowingFragment>unsafeCast(this));
    }
  }
